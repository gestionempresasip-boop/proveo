...
export default async function AdminProductosPage() {
  ...
  const [{ data: products }, { data: categories }] = await Promise.all([
    sb.from('products')
      .select('id, name, description, price, unit, min_order_quantity, order_increment, is_active, category_id, image_url, cost_price, iva_rate, margin, pending_review, product_categories(name), product_category_links(category_id)')
      .is('deleted_at', null)
      .order('name'),
